...
ITEM_ID = "QSE-CORP-OPERATION-0001"
TITLE = "8.0 Operation"

HTML = '''
<header className="mb-8">
  <h1 className="text-3xl font-bold text-gray-900 mb-2">8.0 Operation</h1>
  <p className="text-lg text-gray-600">This section contains the core operational procedures and templates that govern our project execution and service delivery, ensuring QSE requirements are met at the worksite.</p>
</header>

...
export default async function NcrDetailPage({ params }: NcrDetailPageProps) {
  ...
  if (!session?.user) {
    redirect(`/auth/login?message=auth_required&redirectTo=/app/projects/${projectId}/ncrs/${ncrId}`)
  }
        ...
        <Alert variant="destructive">
          ...
          <div className="mt-4">
            <Button variant="outline" asChild>
              <Link href={`/app/projects/${projectId}/ncrs`}>
  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <Link href={`/app/projects/${projectId}/ncrs`} className="text-sm text-muted-foreground hover:underline flex items-center">
            <ArrowLeftIcon className="mr-2 h-4 w-4" />
        ...
        <div className="flex space-x-2">
          <Button variant="outline" asChild>
            <Link href={`/app/projects/${projectId}/ncrs/${ncrId}/edit`}>
          ...
          <NcrDeleteButton
            ...
            onDeleteRedirect={`/app/projects/${projectId}/ncrs`}
          />
        </div>
      </div>

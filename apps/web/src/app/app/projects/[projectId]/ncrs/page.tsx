...
export default async function NcrsPage({ params }: NcrsPageProps) {
  ...
  if (!session?.user) {
    redirect(`/auth/login?message=auth_required&redirectTo=/app/projects/${projectId}/ncrs`)
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <Link href={`/app/projects/${projectId}/overview`} className="text-sm text-muted-foreground hover:underline">
                ← Back to Project
              </Link>
            ...
            <Button asChild>
              <Link href={`/app/projects/${projectId}/ncrs/new`}>
                  ...
                  <TableRow key={ncr.id}>
                    ...
                    <TableCell>
                      <Button variant="outline" size="sm" asChild>
                        <Link href={`/app/projects/${projectId}/ncrs/${ncr.id}`}>

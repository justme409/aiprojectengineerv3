...
export default async function InspectionRequestPage({ params }: InspectionRequestPageProps) {
  ...
  if (!session?.user) {
    redirect(`/auth/login?message=auth_required&redirectTo=/app/projects/${projectId}/inspections/${irId}`)
  }
  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <Link href={`/app/projects/${projectId}/inspections`} className="text-sm text-muted-foreground hover:underline flex items-center">
            <ArrowLeftIcon className="mr-2 h-4 w-4" />
        ...
        <div className="flex space-x-2">
          <Button variant="outline" asChild>
            <Link href={`/app/projects/${projectId}/inspections/${irId}/edit`}>

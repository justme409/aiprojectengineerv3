      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-4 rounded-lg border shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">Total SWMS</div>
            </div>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-2xl font-bold">{swms.filter(s => s.status === 'active').length}</div>
        ...
        <div className="bg-white p-4 rounded-lg border shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-2xl font-bold">{swms.filter(s => isExpiringSoon(s.expiry_date)).length}</div>
        ...
        <div className="bg-white p-4 rounded-lg border shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-2xl font-bold">{swms.filter(s => isExpired(s.expiry_date)).length}</div>

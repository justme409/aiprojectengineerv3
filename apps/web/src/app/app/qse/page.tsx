  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">QSE Management System</h1>
          <p className="text-gray-600 mt-2">Integrated Quality, Safety & Environment Management</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/app/qse/corporate-tier-1">
            ...
            <Link href="/app/qse/corp-policy-roles">
              <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center">
            ...
            <Link href="/app/qse/corp-planning">
              <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center">
            ...
            <Link href="/app/qse/corp-operation">
              <Button variant="outline" className="w-full h-20 flex flex-col items-center justify-center">

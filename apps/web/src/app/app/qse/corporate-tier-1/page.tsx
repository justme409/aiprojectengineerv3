...
import { FileText, Eye, Edit, Download, Plus, Search } from 'lucide-react'
...
export default function CorporateTier1Page() {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await fetch('/api/v1/qse?category=tier_1')
      if (response.ok) {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Corporate Tier 1</h1>
          <p className="text-gray-600 mt-2">IMS Manual and Core Policies</p>
        </div>
        <Button>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            {searchTerm
              ...
              : 'Create your first Tier 1 document to get started'
            }
          </p>
          {!searchTerm && (
            <Button>
